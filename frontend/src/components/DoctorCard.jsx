...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div onClick={()=>navigate(`/appointment/${doctor._id}`)}  className='w-64 border border-teal-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-300'>
      <img className='w-full bg-primary/10' src={doctor.image} alt='' />
      <div className='p-4'>
